...
def get_github_user_info():
        ...
        if user_response.status_code == 200:
            ...
            if repos_response.status_code == 200:
                ...
                return {
                    ...
                    "bio": config.get('bio', 'C++, Java and Python Developer'),  # 使用配置文件中的bio
    ...
    return {
        ...
        "tech_stack": [
            {"name": "C++", "color": "#7a0099"},
            {"name": "Java", "color": "#ff5511"},
            {"name": "Python", "color": "#ffff33"},
            {"name": "Shell", "color": "#ffff33"},
            {"name": "HTML", "color": "#7a0099"},
            {"name": "Javascript", "color": "#7a0099"}
        ]
    }
...
def analyze_tech_stack(repos):
    ...
    try:
        ...
        theme = current_app.config.get('theme', {
            'primary_color': '#8a0099',
            'secondary_color': '#2575gf',
            'dark_primary_color': '#6a0088',
            'dark_secondary_color': '#2570db'
        })
